...
var uri = "mongodb+srv://mohamed4016:gha4016@cluster0.sfcfp.mongodb.net/db?authSource=admin&replicaSet=atlas-1n7t8y-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true";
...
async function main() {
    ...
    await mongoose.connect('mongodb+srv://mohamed4016:gha4016@cluster0.sfcfp.mongodb.net/db?authSource=admin&replicaSet=atlas-1n7t8y-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true');
...
app.post('/galaxy', function(req, res) {
    ...
    function updateq(quantityw) {
        CartTable.findOneAndUpdate({ "$and": [{ "list.name": "Galaxy S21 Ultra" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
    }
...
app.post('/leaves', function(req, res) {
    ...
    function updateq(quantityw) {
        CartTable.findOneAndUpdate({ "$and": [{ "list.name": "Leaves of Grass" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
    }
...
app.post('/sun', function(req, res) {
        ...
        function updateq(quantityw) {
            CartTable.findOneAndUpdate({ "$and": [{ "list.name": "The Sun and Her Flowers" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
        }
...
app.post('/boxing', function(req, res) {
    ...
    function updateq(quantityw) {
        CartTable.findOneAndUpdate({ "$and": [{ "list.name": "Boxing Bag" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
    }
...
app.post('/iphone', function(req, res) {
    ...
    function updateq(quantityw) {
        CartTable.findOneAndUpdate({ "$and": [{ "list.name": "Iphone 13 Pro" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
    }
...
app.post('/tennis', function(req, res) {
    ...
    function updateq(quantityw) {
        CartTable.findOneAndUpdate({ "$and": [{ "list.name": "Tennis Racket" }, { "username": req.session.userid }] }, { $set: { 'list.$.quantity': quantityw } }).exec();
    }
...
app.post('/action_galaxy', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "Galaxy S21 Ultra" } } }).exec();
    }
...
app.post('/action_iphone', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "Iphone 13 Pro" } } }).exec();
    }
});
app.post('/action_leaves', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "Leaves of Grass" } } }).exec();
    }
});
app.post('/action_sun', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "The Sun and Her Flowers" } } }).exec();
    }
});
app.post('/action_tennis', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "Tennis Racket" } } }).exec();
    }
});
app.post('/action_box', function(req, res) {
    ...
    function deletex() {
        CartTable.findOneAndUpdate({ "username": req.session.userid }, { $pull: { 'list': { 'name': "Boxing Bag" } } }).exec();
    }
});
